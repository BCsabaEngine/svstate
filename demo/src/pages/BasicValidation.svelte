...
<div class="max-w-xl flex-1 rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
	...
	<div class="space-y-4">
		...
		<div>
			<label for="age" class="mb-2 block text-sm font-medium text-gray-900">Age *</label>
			<input
				id="age"
				type="number"
		...
		<div>
			<label for="bio" class="mb-2 block text-sm font-medium text-gray-900">Bio (optional)</label>
			<textarea
				id="bio"
		...
		<div>
			<label for="website" class="mb-2 block text-sm font-medium text-gray-900"
...
<div class="w-80 flex-shrink-0 space-y-4">
	...
	<div class="rounded-lg border border-gray-300 bg-gray-50 p-4 shadow-inner">
		...
		<pre class="overflow-auto text-sm text-gray-600">{JSON.stringify(data, null, 2)}</pre>
	</div>
	...
	<div class="rounded-lg border border-gray-300 bg-gray-50 p-4 shadow-inner">
		...
		<pre class="overflow-auto text-xs text-gray-600">{JSON.stringify($errors, null, 2)}</pre>
	</div>
	<button
		type="button"
